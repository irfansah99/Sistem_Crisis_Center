<x-layout>
    ...
    <form id="form-ubah-{{ $edit->id }}" action="{{ route('instansi.profil.update', $edit->id) }}" method="POST"
        ...
        <div>
            ...
            <input type="text" name="nama_instansi" id="nama_instansi" value="{{ old('nama_instansi', $edit->nama_instansi) }}"
        ...
        <div>
            ...
            <input type="text" name="address" id="address" value="{{ old('address', $edit->address) }}"
                ...
                class="border rounded w-full p-2 text-slate-700 @error('address') border-red-500 @enderror">
            @error('address')
                <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        </div>
