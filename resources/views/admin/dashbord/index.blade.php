<x-layout_admin>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 text-gray-800 space-y-3 mb-5">
        ...
        <p>
            Hak akses Anda: <span class="font-semibold text-green-500">{{ auth('admin')->user()->role === 'superadmin'? 'Super Admin' : 'Admin' }}</span>
        </p>
        <hr class="my-2 border-gray-300">

        <p class="italic text-sm text-gray-600">
            Setiap laporan berarti <span class="font-bold text-red-600">nyawa dan keselamatan.</span> Aplikasi ini hadir
            untuk Anda.
        </p>
