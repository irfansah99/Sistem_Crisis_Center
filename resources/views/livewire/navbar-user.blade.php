    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="/beranda"
                            class="{{ request()->is('beranda') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} rounded-md  px-3 py-2 text-sm font-medium "
                            wire:navigate>Home</a>
                        <a href="/riwayat"
                            class="{{ request()->is('riwayat') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium  hover:bg-gray-700 hover:text-white"
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div x-show="isOpen"@click.away="isOpen = false" x-cloak
                            ...
                            <a href="{{ route('profil.edit') }}" class="block px-4 py-2 text-sm text-gray-700"
                            ...
                            <form action="/logout" method="POST">
                                ...
                                <button class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                    id="user-menu-item-2" type="submit">Log Out</button>
                            </form>
                        </div>
                    </div>
        ...
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                <a href="/beranda"
                    class="{{ request()->is('beranda') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} block rounded-md px-3 py-2 text-sm font-medium">
                    Home
                </a>
                <a href="/tagihan"
                    class="{{ request()->is('tagihan') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} block rounded-md px-3 py-2 text-sm font-medium">
                    Tagihan
                </a>
                <a href="/riwayat"
                    class="{{ request()->is('riwayat') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }} block rounded-md px-3 py-2 text-sm font-medium">
                    Riwayat
                </a>
...
<script>
    ...
    channel.bind("report.updated", function(data) {
        window.dispatchEvent(new CustomEvent('notifikasiuser', {
            detail: data
        }));
